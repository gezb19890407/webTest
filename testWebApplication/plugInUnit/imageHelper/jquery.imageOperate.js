...
(function ($) {
        ...
        initImageDom: function () {
            ...
            for (var i = 0, len = this.options.dataSource.length; i < len; i++) {
                ...
                imageHtml += "<div class='imageOperate_BorderDiv'><img imageFileType = '" + imageFileType
                            + "' htmlViewUrl='" + url + "' class='imageOperate_BorderImage' defaultSrc='" + defaultSrc + "' src='" + imageUrl + "'  /></div>";
            };
    ...
    getWebSiteRootUrl();
    document.write('<link href="' + window.webSiteCurrentUrl + 'jquery.imageOperate.css" rel="stylesheet" type="text/css" />');
})(jQuery);